...
public class OPRSHandTracker16fps : CollisionTester
{
#if UNITY_EDITOR
    ...
    const string DLL_NAME = "beta_CAM2";
    ...
    float update;
    Vector3 dll_xyz, dll_xyz_copy, dll_xyz_tumme, dll_xyz_mid, LF_position, CF_position;
    int counter = 0;
    //For threading tasks
    Task<float> OPTask;
    ...
    protected Vector3 RawIndexFingerPos;
    ...
    void Update()
    {
        ...
        RawIndexFingerPos =dll_xyz_copy;
        // Tumme
    ...
    void OnApplicationQuit()
    {
        ...
        // Clear All Lists
        vector3List_TUM.Clear();
        vector3List_PEK.Clear();
        vector3List_MID.Clear();
